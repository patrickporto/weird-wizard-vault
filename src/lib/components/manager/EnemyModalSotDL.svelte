            ...
            <div class="flex-1 overflow-y-auto p-6 custom-scrollbar bg-slate-800/50">
                {#if tab === 'general'}
                    <div class="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div>
                            <label for="enemy-desc-text" class="text-xs text-slate-500 uppercase font-bold block mb-1">{$t('session.enemy_modal.description')}</label>
                            <textarea
                                id="enemy-desc-text"
                ...
                {:else if tab === 'stats'}
                    <div class="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        ...
                        <div>
                            <h4 class="text-indigo-400 font-bold text-sm uppercase mb-3 border-b border-indigo-500/20 pb-2">{$t('session.enemy_modal.main_attributes')}</h4>
