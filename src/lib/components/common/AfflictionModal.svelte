                        ...
                        <div class="space-y-1">
                             {#each afflictions as aff}
                                 <div class="text-xs leading-tight">
                                     <span class="text-red-400 font-bold">{$t(`character.afflictions.${aff}`)}:</span> <span class="text-slate-400">{$t(`sofww.afflictions.${aff.toLowerCase().replace(' ', '_')}.effect`)}</span>
                                 </div>
                             {/each}
                        </div>
                     {/if}
